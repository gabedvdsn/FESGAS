...
namespace FESGameplayAbilitySystem
{
    public struct ModifiedAttributeValue
    {
        ...
        public SourcedModifiedAttributeValue ToSourced(IAttributeImpactDerivation derivation)
        {
    ...
    public struct SourcedModifiedAttributeValue
    {
        ...
        public SourcedModifiedAttributeValue(IAttributeImpactDerivation derivation, float deltaCurrentValue, float deltaBaseValue, bool workable = true)
        {
        ...
        public SourcedModifiedAttributeValue(IAttributeImpactDerivation derivation, IAttributeImpactDerivation baseDerivation, float deltaCurrentValue, float deltaBaseValue,
            bool workable = true)
        {
            Derivation = derivation;
